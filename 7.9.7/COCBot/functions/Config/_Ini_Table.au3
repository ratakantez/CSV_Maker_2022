...
Global Const $g_iIniLinesMax = 1200 ; As of 2017-02-24, the number of active config.ini lines is 685..... As of 2022-11-16, there are 1029 config.ini lines (All may not be active, but I did not got thru - Chilly Chill)
