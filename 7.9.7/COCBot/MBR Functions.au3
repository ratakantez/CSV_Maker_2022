...
;##########CSV MAKER###########################################################################################
;##############################################################################################################
#include "CSVMAKER2022\FuncAndGui\Variable.au3";###############################################################
#include "CSVMAKER2022\Configs.au3";###########################################################################
#include "CSVMAKER2022\FuncAndGui\DropWrite\_MainDropFunc.au3";################################################
#include "CSVMAKER2022\FuncAndGui\DropWrite\CheckIFMultiIsFromSideA.au3";######################################
#include "CSVMAKER2022\FuncAndGui\DropWrite\CheckIFMultiIsFromSideB.au3";######################################
#include "CSVMAKER2022\FuncAndGui\DropWrite\CheckIFMultiIsFromSideC.au3";######################################
#include "CSVMAKER2022\FuncAndGui\DropWrite\CheckIFMultiIsFromSideD.au3";######################################
#include "CSVMAKER2022\FuncAndGui\DropWrite\CheckIFMultiIsFromSideE.au3";######################################
#include "CSVMAKER2022\FuncAndGui\DropWrite\CheckIFMultiIsFromSideF.au3";######################################
#include "CSVMAKER2022\FuncAndGui\DropWrite\CheckIFMultiIsFromSideG.au3";######################################
#include "CSVMAKER2022\FuncAndGui\DropWrite\CheckIFMultiIsFromSideH.au3";######################################
#include "CSVMAKER2022\FuncAndGui\DropWrite\DropFuncForSideA.au3";#############################################
#include "CSVMAKER2022\FuncAndGui\DropWrite\DropFuncForSideB.au3";#############################################
#include "CSVMAKER2022\FuncAndGui\DropWrite\DropFuncForSideC.au3";#############################################
#include "CSVMAKER2022\FuncAndGui\DropWrite\DropFuncForSideD.au3";#############################################
#include "CSVMAKER2022\FuncAndGui\DropWrite\DropFuncForSideE.au3";#############################################
#include "CSVMAKER2022\FuncAndGui\DropWrite\DropFuncForSideF.au3";#############################################
#include "CSVMAKER2022\FuncAndGui\DropWrite\DropFuncForSideG.au3";#############################################
#include "CSVMAKER2022\FuncAndGui\DropWrite\DropFuncForSideH.au3";#############################################
#include "CSVMAKER2022\FuncAndGui\DropWrite\SpellDropFunc.au3";################################################
#include "CSVMAKER2022\FuncAndGui\Gui\AfterStartGUI.au3";######################################################
#include "CSVMAKER2022\FuncAndGui\Gui\MainGUI.au3";############################################################
#include "CSVMAKER2022\FuncAndGui\Gui\MultiDropGUIforSide _A.au3";#############################################
#include "CSVMAKER2022\FuncAndGui\Gui\MultiDropGUIforSide _B.au3";#############################################
#include "CSVMAKER2022\FuncAndGui\Gui\MultiDropGUIforSide _C.au3";#############################################
#include "CSVMAKER2022\FuncAndGui\Gui\MultiDropGUIforSide _D.au3";#############################################
#include "CSVMAKER2022\FuncAndGui\Gui\MultiDropGUIforSide _E.au3";#############################################
#include "CSVMAKER2022\FuncAndGui\Gui\MultiDropGUIforSide _F.au3";#############################################
#include "CSVMAKER2022\FuncAndGui\Gui\MultiDropGUIforSide _G.au3";#############################################
#include "CSVMAKER2022\FuncAndGui\Gui\MultiDropGUIforSide _H.au3";#############################################
#include "CSVMAKER2022\FuncAndGui\Gui\TrainMenuGui.au3";#######################################################
#include "CSVMAKER2022\FuncAndGui\GuiControls\MultiDropControls\MultiDropGUIControlsForSide _A.au3";###########
#include "CSVMAKER2022\FuncAndGui\GuiControls\MultiDropControls\MultiDropGUIControlsForSide _B.au3";###########
#include "CSVMAKER2022\FuncAndGui\GuiControls\MultiDropControls\MultiDropGUIControlsForSide _C.au3";###########
#include "CSVMAKER2022\FuncAndGui\GuiControls\MultiDropControls\MultiDropGUIControlsForSide _D.au3";###########
#include "CSVMAKER2022\FuncAndGui\GuiControls\MultiDropControls\MultiDropGUIControlsForSide _E.au3";###########
#include "CSVMAKER2022\FuncAndGui\GuiControls\MultiDropControls\MultiDropGUIControlsForSide _F.au3";###########
#include "CSVMAKER2022\FuncAndGui\GuiControls\MultiDropControls\MultiDropGUIControlsForSide _G.au3";###########
#include "CSVMAKER2022\FuncAndGui\GuiControls\MultiDropControls\MultiDropGUIControlsForSide _H.au3";###########
#include "CSVMAKER2022\FuncAndGui\GuiControls\AddCSVButton.au3";###############################################
#include "CSVMAKER2022\FuncAndGui\GuiControls\AfterClose.au3";#################################################
#include "CSVMAKER2022\FuncAndGui\GuiControls\AfterStart.au3";#################################################
#include "CSVMAKER2022\FuncAndGui\GuiControls\ArmyPointsControl.au3";##########################################
#include "CSVMAKER2022\FuncAndGui\GuiControls\BuildingRadioControl.au3";#######################################
#include "CSVMAKER2022\FuncAndGui\GuiControls\CalcTroopSize.au3";##############################################
#include "CSVMAKER2022\FuncAndGui\GuiControls\CursorControl.au3";##############################################
#include "CSVMAKER2022\FuncAndGui\GuiControls\GetQTY_X_VECT.au3";##############################################
#include "CSVMAKER2022\FuncAndGui\GuiControls\GetRandomXY.au3";################################################
#include "CSVMAKER2022\FuncAndGui\GuiControls\GetSleepSize.au3";###############################################
#include "CSVMAKER2022\FuncAndGui\GuiControls\GetWidenessSize.au3";############################################
#include "CSVMAKER2022\FuncAndGui\GuiControls\Hide-Show-Enable-DisableControlsInLoop.au3";#####################
#include "CSVMAKER2022\FuncAndGui\GuiControls\Hotkeys.au3";####################################################
#include "CSVMAKER2022\FuncAndGui\GuiControls\InfoControls.au3";###############################################
#include "CSVMAKER2022\FuncAndGui\GuiControls\OpenAndCloseMainGUI.au3";########################################
#include "CSVMAKER2022\FuncAndGui\GuiControls\RadioOne-MultiDropControls.au3";#################################
#include "CSVMAKER2022\FuncAndGui\GuiControls\SpellPointsControl.au3";#########################################
#include "CSVMAKER2022\FuncAndGui\GuiControls\TrainResetControls.au3";#########################################
#include "CSVMAKER2022\FuncAndGui\GuiControls\TroopsNameControl.au3";##########################################
#include "CSVMAKER2022\FuncAndGui\GuiControls\UndoButton.au3";#################################################
#include "CSVMAKER2022\FuncAndGui\GuiControls\WaitControl.au3";################################################
#include "CSVMAKER2022\FuncAndGui\Randomise\RandomiseAB.au3";##################################################
#include "CSVMAKER2022\FuncAndGui\Randomise\RandomiseDB.au3";##################################################
#include "CSVMAKER2022\FuncAndGui\AddNotes.au3";###############################################################
#include "CSVMAKER2022\FuncAndGui\MakeFile.au3";###############################################################
#include "CSVMAKER2022\FuncAndGui\SideFile.au3";###############################################################
#include "CSVMAKER2022\FuncAndGui\SetTrain.au3";###############################################################
;##############################################################################################################
;##############################################################################################################
