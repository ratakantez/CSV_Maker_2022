...
;~ 		$g_hLblDonate = GUICtrlCreateLabel(GetTranslatedFileIni("MBR GUI Design Bottom", "LblDonate", "Support the Development"), $x + 293, $y + 80, 142, 24, $SS_RIGHT)
		$g_hLblDonate = GUICtrlCreateLabel(GetTranslatedFileIni("MBR GUI Design Bottom", "LblDonate", "Support the Development"), $x + 380, $y + 77, 72, 31, $SS_RIGHT) ;CSV MAKER 2022
...
;~ ##########################################CSV MAKER 2022######################################################################
		Local $x = 10, $y = 10 ;#####################################################################################################
		$g_hCSVMakerMainButton = GUICtrlCreatePic("",$x + 286 ,$y + 75, 90, 27);################################################
		GUICtrlSetCursor (-1, 0);#####################################################################################################
		_GDIPlus_Startup();#####################################################################################################
		GUICtrlSendMsg($g_hCSVMakerMainButton, 0x0172, 0, _GDIPlus_BitmapCreateHBITMAPFromBitmap(@ScriptDir & @ScriptDir & "\COCBot\CSVMAKER2022\USE\mainButton.png"))
		_WinAPI_DeleteObject(GUICtrlSendMsg($g_hCSVMakerMainButton,0x0172,0, _GDIPlus_BitmapCreateHBITMAPFromBitmap(_GDIPlus_ImageLoadFromFile(@ScriptDir & "\COCBot\CSVMAKER2022\USE\mainButton.png"))))
...
;~ ~ ##############################################################################################################################
	    ...
	    GUI_MultiDropforH();######################################################################################################
;~ 	    GUI_deneme();######################################################################################################
;~ 		GUISetState(@SW_SHOW, $GUI_deneme_in_function)
